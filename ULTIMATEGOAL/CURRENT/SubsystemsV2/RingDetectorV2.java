...
public class RingDetectorV2 {
     ...
     */
    public RingDetectorV2(@NotNull LinearOpMode opMode){
        this.opMode = opMode;
     ...
     */
    public TargetWobbleZoneV2 scan(){
        TargetWobbleZoneV2 targetZone = null;

        if (tfod != null){
            List<Recognition> recognitions = tfod.getRecognitions();
            if (recognitions.isEmpty()){
                targetZone = TargetWobbleZoneV2.ZONE_A;
            }else if (recognitions.get(0).getLabel().equals(SINGLE_RING)){
                targetZone = TargetWobbleZoneV2.ZONE_B;
            }else if (recognitions.get(0).getLabel().equals(FOUR_RINGS)){
                targetZone = TargetWobbleZoneV2.ZONE_C;
            }
        }
