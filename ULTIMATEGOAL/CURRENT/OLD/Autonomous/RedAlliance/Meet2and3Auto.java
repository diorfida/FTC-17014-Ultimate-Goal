...
@Deprecated
@Disabled
@Autonomous(name = "Meet 2 and 3 Auto", group = "red")
public class Meet2and3Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory get2ndGoalB = fierceBot.trajectoryBuilder(deliver1stGoalB.end())
                ...
                .splineToConstantHeading(new Vector2d(-36.0, -30.5), Math.toRadians(180.0))
                .build();
        ...
        Trajectory getStackB = fierceBot.trajectoryBuilder(deliver2ndGoalB.end())
                .splineToConstantHeading(new Vector2d(20, -40), Math.toRadians(270.0))
                .splineToConstantHeading(new Vector2d(-20.0, -42.5), Math.toRadians(180.0))
                .addTemporalMarker(.8, helper::startIntake)
                .build();

        Trajectory shootStack = fierceBot.trajectoryBuilder(getStackB.end())
                .lineToLinearHeading(new Pose2d(-1, -43 + LAUNCHER_CIRCLE_RADIUS, 0.0))
        ...
        Trajectory get2ndGoalC2 = fierceBot.trajectoryBuilder(get2ndGoalC1.end())
                ...
                .addDisplacementMarker(helper::swingClawOut)
                .splineToConstantHeading(new Vector2d(-20.0, -25.0), Math.toRadians(180.0))
                .splineToConstantHeading(new Vector2d(-35.75, -29.5), Math.toRadians(180.0))
                .build();
