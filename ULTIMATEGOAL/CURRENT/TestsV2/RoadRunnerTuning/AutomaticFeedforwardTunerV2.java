...
import org.firstinspires.ftc.teamcode.ULTIMATEGOAL.CURRENT.SubsystemsV2.Util.LoggingUtilV2;
import org.firstinspires.ftc.teamcode.ULTIMATEGOAL.CURRENT.SubsystemsV2.Util.RegressionUtilV2;

import java.util.ArrayList;
import java.util.List;

import static org.firstinspires.ftc.teamcode.ULTIMATEGOAL.CURRENT.SubsystemsV2.Drivetrain.DriveConstantsV2.MAX_RPM;
...
import static org.firstinspires.ftc.teamcode.ULTIMATEGOAL.CURRENT.SubsystemsV2.Drivetrain.DriveConstantsV2.rpmToVelocity;
...
public class AutomaticFeedforwardTunerV2 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        RegressionUtilV2.RampResult rampResult = RegressionUtilV2.fitRampData(
                timeSamples, positionSamples, powerSamples, fitIntercept,
                LoggingUtilV2.getLogFile(Misc.formatInvariant(
        ...
        if (fitAccelFF) {
            ...
            RegressionUtilV2.AccelResult accelResult = RegressionUtilV2.fitAccelData(
