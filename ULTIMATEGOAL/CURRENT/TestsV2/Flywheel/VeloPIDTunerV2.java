package org.firstinspires.ftc.teamcode.ULTIMATEGOAL.CURRENT.TestsV2.Flywheel;
...
@Config
@Disabled
@TeleOp(name = "Flywheel PID Tuner V2")
public class VeloPIDTunerV2 extends LinearOpMode {
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(20, 0, 0, 13.75);
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TuningControllerV2 tuningController = new TuningControllerV2();
        ...
        while (!isStopRequested() && opModeIsActive()) {
            ...
            telemetry.addData("upperBound", TuningControllerV2.rpmToTicksPerSecond(TuningControllerV2.TESTING_MAX_SPEED * 1.15));
    ...
    public static double getMotorVelocityF() {
        ...
        return 32767 * 60.0 / (TuningControllerV2.MOTOR_MAX_RPM * TuningControllerV2.MOTOR_TICKS_PER_REV);
    }
}
